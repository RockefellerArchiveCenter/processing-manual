...
- The Project Vitals document is intended to serve as a simplified processing plan, focusing on the critical data necessary to visualize, plan, and execute the work ahead.
...
- Once the Project Vitals document is submitted, discussed, and approved, the Assistant Director for Processing will share it with the Archives Strategy Group and the Processing Team.
...
6.  Processing Vitals
    ...
    - Processing Level
7.  Projected Work Time

#### Project Vitals Template for substantial Redescription Projects
...
2. Physical Vitals
    ...
    - Current number of boxes
    - Current Location
    - Are any applicable born-digital files or digital objects impacted?
3.  Descriptive Vitals
    - Collection/Finding Aids impacted?
    - Structured data (Agents/Subjects) impacted?
    - If the number of Collections/Finding Aids or Structure data terms is more than three, summarize the descriptive work planned rather than specifying the collections/terms.
    - How will the existing description be revised or changed?
    - Is this reparative description? If so, briefly describe the intended impact of the revisions.
    - Will these actions require a content review of the records?
    - List any recommendations for the creation of expansion of RAC-optional notes.
4.  Processing Vitals
    - Conditions of Access
    - Establishing Archival Context and Structure
        - What are these records/papers?
        ...
        - Are there any biases, institutional or personal, that might apply to the material?
        - Arrangement
            - Will the current arrangement be revised as part of the work? If so, how? (Such as by creating or revising Series titles)      
5.  Projected Work Time
6.  Staffing (if collaborative)

These Project Vitals templates are also available in the Processing folder of the All Staff SharePoint network.
...
- Processing archivist should coordinate with Collections Management whenever the project requires use of preservation supplies or non-standard containers --- including but not limited to: oversized or undersized flat boxes, clamshell boxes, index card boxes, microform boxes, still image containers, newspaper-sized and textile boxes, and flat files or tubes.
- The Collections Management team can assist with –
    ...
    - Identifying and ordering appropriately-sized mylar, paper enclosures, support products, and other supplies which facilitate stabilization and long-term preservation.
